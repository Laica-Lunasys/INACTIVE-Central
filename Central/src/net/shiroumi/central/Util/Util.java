...
public class Util {
	...
	public static Player findPlayer(String par1Player, CentralCore par2Plugin, CommandSender par3Sender){
	...
	public static boolean hasPerm(String par1Perm, CommandSender par2Player, CentralCore par3Plugin){
		return hasPerm(par1Perm, par2Player, par3Plugin, true);
	}
	public static boolean hasPerm(String par1Perm, CommandSender par2Player, CentralCore par3Plugin, boolean hasMessage){
